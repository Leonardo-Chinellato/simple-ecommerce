...
if(isset($_POST['update_cart_submit'])){
    ...
    foreach($_POST['quantity'] as $id => $row){
        $result = mysqli_query($con, "UPDATE cart_details SET quantity = $row WHERE product_id = $id;");
    }
...
<head>
    ...
    <script>
        function deleteProduct(id){
            ...
            btn.setAttribute("href", "delete_cart_item.php?delete_cart_product=" + id);
        }
    </script>
</head>
                                        ...
                                        <table class="table table-bordered text-center">
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="text-center form-control w-50 m-auto" type="number" min="1" max="100" id="product_quantity" name="quantity[<?php echo $product_id; ?>]" required="required" value="<?php echo $quantity ?>"></td>
                                                    <td><?php    
                                                    ...
                                                    <td><a href="javascript:void(0);" type="button" class="text-danger" data-bs-toggle="modal" onclick="deleteProduct(<?php echo $product_id; ?>)" data-bs-target="#exampleModalProducts"><i class="fa-solid fa-trash"></i></a></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
